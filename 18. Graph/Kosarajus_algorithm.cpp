...
//  Count the no. of strongly connected components in a graph
...
3. Do DFS of the reversed graph in the order obtained in step 1.
   For every vertex, print all reachable vertices as one strong 
   connected component.



Implementations of step 1
